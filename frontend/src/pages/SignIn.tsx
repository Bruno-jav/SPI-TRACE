    ...
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex flex-1 bg-gradient-to-br from-cyber/20 to-background items-center justify-center p-8 relative overflow-hidden">
        ...
        >
          ...
          <h2 className="text-3xl font-bold mb-4">Protect Your Data</h2>
          <p className="text-muted-foreground text-lg leading-relaxed">
            Monitor your sensitive information across the dark web and receive instant alerts when your data is compromised.
          </p>
        </motion.div>
      </div>
          ...
          >
            ...
            >
              ...
              <div className="space-y-1 text-sm text-muted-foreground">
                <p>
                  <span className="font-medium">Client:</span> user@example.com
                </p>
                <p>
